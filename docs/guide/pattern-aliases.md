...
new-branch --use feature --type feat --title "Add login" --id PROJ-123

# Use the "hotfix" pattern
new-branch --use hotfix --title "Fix crash on startup" --id PROJ-456

# Use the "release" pattern
new-branch --use release --title "v2.0"
```
...
new-branch --pattern "{title:slugify}" --use feature --title "My task"
...
```bash
$ new-branch --use typo --title "My task"
...
new-branch --use feature --title "User dashboard" --id PROJ-789 --create

# Urgent fix
new-branch --use hotfix --title "Fix payment crash" --id PROJ-790 --create

# Preparing a release
new-branch --use release --title "v3.1" --create
```
